...
confusion_matrix
accuracy = (38940+1833)/(45211) # 90.18
accuracy
...
train_model = sm.logit('y_yes~day+duration+campaign+job_blue_collar+job_entrepreneur+job_housemaid+job_management+job_retired+job_self_employed+job_student+job_technician+marital_single+education_secondary+education_tertiary+education_unknown+housing_yes+loan_yes+contact_telephone+contact_unknown+month_aug+month_dec+month_jan+month_jul+month_jun+month_mar+month_may+month_nov+month_oct+month_sep+poutcome_other+poutcome_success',data = train).fit()

train_model = sm.logit('y_yes~day+duration+campaign+job_blue_collar+job_housemaid+job_retired+job_self_employed+job_student+marital_single+education_secondary+education_tertiary+education_unknown+housing_yes+loan_yes+contact_telephone+contact_unknown+month_aug+month_dec+month_jan+month_jul+month_jun+month_mar+month_may+month_nov+month_oct+month_sep+poutcome_other+poutcome_success',data = train).fit()

train_model = sm.logit('y_yes~day+duration+campaign+job_blue_collar+job_housemaid+job_retired+job_student+marital_single+education_secondary+education_tertiary+housing_yes+loan_yes+contact_telephone+contact_unknown+month_aug+month_dec+month_jan+month_jul+month_jun+month_mar+month_may+month_nov+month_oct+month_sep+poutcome_other+poutcome_success',data = train).fit()
...
confusion_matrix
accuracy_train = (27234+1321)/(31647) # 90.22
accuracy_train
...
confusion_matrix
accuracy_test = (11730+512)/(13564) # 90.25
accuracy_test
...
# fpr => false positive rate
# tpr => true positive rate
fpr, tpr, threshold = metrics.roc_curve(test.y_yes, test_pred)
